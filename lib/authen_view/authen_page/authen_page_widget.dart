...
class AuthenPageWidget extends StatefulWidget {
  const AuthenPageWidget({super.key});

  @override
  State<AuthenPageWidget> createState() => _AuthenPageWidgetState();
}

class _AuthenPageWidgetState extends State<AuthenPageWidget> {
  late AuthenPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthenPageModel());
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/car-rental_7840945.png',
                                            width: 100.0,
                                            fit: BoxFit.cover,
                                          ),
                                        ),
